...
- Segmentation penalty: DISABLED (no reward/punishment for "/" or "//")
- Segmentation reward: DISABLED (no reward/punishment for "/" or "//")
"""
...
MODELS_TO_TRAIN = {
    # 'hfl/cino-base-v2': 'cino_base_v2_ALTO_arch_3class_NO_SEG_24_10',
    # 'bert-base-multilingual-cased': 'mbert_cased_ALTO_arch_3class_NO_SEG_24_10',
    # 'xlm-roberta-base': 'xlm_roberta_base_ALTO_arch_3class_NO_SEG_24_10',
    # 'sangjeedondrub/tibetan-roberta-base': 'tibetan_roberta_ALTO_arch_3class_NO_SEG_24_10',
    'OMRIDRORI/mbert-tibetan-continual-wylie-final': 'mbert_tibetan_wylie_ALTO_arch_3class_NO_SEG_24_10',
}
