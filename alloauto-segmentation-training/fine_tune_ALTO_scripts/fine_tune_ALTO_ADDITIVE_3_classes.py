"""
3-Class ALTO with ADDITIVE Loss (Multiple Models Version)
==========================================================
...
EXACT SAME parameters as 4-class version:
...
MODELS_TO_TRAIN = [
    ...
    #     'output_dir': './alloauto-segmentation-training/benchmark_models_ALTO_architecture/CINO_additive_seg_loss_3class_24_10'
    # },
    # {   # XLM Roberta
    #     'model_name': 'xlm-roberta-base',
    #     'output_dir': './alloauto-segmentation-training/benchmark_models_ALTO_architecture/XLM_roberta_additive_seg_loss_3class_24_10'
    # },
    # {   # mBERT
    #     'model_name': 'bert-base-multilingual-cased',
    #     'output_dir': './alloauto-segmentation-training/benchmark_models_ALTO_architecture/mBERT_additive_seg_loss_3class_23_10'
    # },
    # {   # tibetian roberta
    #     'model_name': 'sangjeedondrub/tibetan-roberta-base',
    #     'output_dir': './alloauto-segmentation-training/benchmark_models_ALTO_architecture/tibetan_roberta_additive_seg_loss_3class_24_10'
    # },
]
...
class SwitchFocusedLossAdditive3Class(nn.Module):
    ...
    def check_segmentation_alignment(self, seg_marks, predictions, b, seq_len):
        """Check if switches align with segmentation marks - EXACT SAME logic"""
...
class SimpleSwitchTrainerAdditive3Class(Trainer):
    ...
    def __init__(self, switch_recall_weight=10.0, proximity_tolerance=5,
        ...
        print(f"  Segmentation penalty: {segmentation_penalty}")
        print(f"  Segmentation reward: {segmentation_reward}")
...
def train_alto_3class_additive(model_name, output_dir):
    ...
    print(f"  • Segmentation penalty: 2.0")
    print(f"  • Segmentation reward: 1.0")
