...
def train_tibetan_code_switching(target_switch_ratio=0.67):
    ...
    output_dir = './alloauto-segmentation-training/fine_tuned_ALTO_models/ALTO_allow_non_switch_test_train_and_fixed_loss_7_10_no_same_seqnence_simpler_loss'
    ...
    class SimpleSwitchTrainer(Trainer):
        ...
        def __init__(self, *args, **kwargs):
            ...
            self.loss_fn = SwitchFocusedLoss(
                switch_recall_weight=10.0,  # Moderate weight
