...
def train_xlmroberta_baseline():
    ...
    print(f"\nLoading {model_name}...")
    print("Note: XLM-RoBERTa is generally stronger than mBERT for multilingual tasks")
...
if __name__ == "__main__":
    trainer, model, tokenizer = train_xlmroberta_baseline()